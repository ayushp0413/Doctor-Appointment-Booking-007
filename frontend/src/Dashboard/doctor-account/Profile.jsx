...
const Profile = ({doctorData}) => {
    ...
    const handleReusableInputChangeFunc = (key, index, event)=> {
        ...
        setFormData(prev => {
            const uploadItems = [...prev[key]]

            uploadItems[index][name] = value
    ...
    const addQualification = e => {
        ...
        addItem('qualifications', {
             startingDate: '', endingDate: '', degree: 'PHD', university: 'XYZ University' 
        })
    };
    ...
    return <div>
        ...
        <form>
            ...
            <div className="mb-5">
                ...
                <button onClick={addQualification} className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-">
                    Add Qualifications
                </button>
            </div>
            ...
            <div className="mb-5">
                ...
                <button onClick={addExperience} className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-">
                    Add Experience
                </button>
            </div>
            ...
            <div className="mb-5">
                ...
                <button onClick={addTimeSlot} className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-">
                    Add TimeSlots
                </button>
            </div>
            ...
            <div className="mb-5">
                ...
                <textarea name="about" rows={5} value={formData.about} placeholder="write avout you" onChange={handleInputChange} className="form__input"></textarea>
            </div>
