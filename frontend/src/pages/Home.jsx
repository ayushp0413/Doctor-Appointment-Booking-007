...
const Home = () => {
  return (
    <>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text__para'>
                  ...
                  Recusandae tempore modi doloribus nobis, pariatur voluptas
              ...
              <div className='mt-[30px] lg:mt-[70px] flex flex-col lg:flex-row lg:items-center gap-5 '>
                ...
                <div>
                  <h2 className='text-[36px] leading-[56px] lg:text-[44px] lg:leading-[54px] font-[700] text-purpleColor'>
                    15+
                  </h2>
                  <span className='w-[100px] h-2 bg-yellowColor rounded-full block mt-[-14px]'></span>
            ...
            <div className='py-[30px] px-5'>
              ...
              <div className='mt-[30px]'>
                ...
                <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                  World-class are care for everyone. Our health System offers
      ...
      <section>
        <div className='container'>
          <div className='xl:x-[470px] mx-auto'>
